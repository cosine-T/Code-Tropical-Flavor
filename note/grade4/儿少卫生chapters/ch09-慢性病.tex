...
\begin{defbox}
\textbf{支气管哮喘（Asthma）}：是一种以慢性气道炎症和气道高反应性为特征的异质性疾病，以反复发作的喘息、咳嗽、气促、胸闷为主要临床表现，常在夜间和/或凌晨发作或加剧。哮喘是\keyword{儿童期最常见的慢性呼吸系统疾病}。

\textbf{流行病学：}我国儿童哮喘患病率呈上升趋势，城市高于农村。约30\%的儿童期哮喘可持续到成人期。哮喘严重影响患儿的学习、生活和身心健康。
\end{defbox}

\begin{keybox}
\textbf{儿童哮喘的危险因素：}
\begin{enumerate}[leftmargin=*]
    \item \imp{遗传因素}——家族过敏史（父母一方患哮喘，子女风险增加2--3倍）
    \item \imp{过敏原暴露}——室内过敏原（尘螨、蟑螂、宠物皮屑、霉菌）、室外过敏原（花粉）
    \item \imp{环境因素}——空气污染（PM2.5、二手烟暴露）、室内装修污染
    \item \imp{呼吸道感染}——婴幼儿期严重RSV或鼻病毒感染
    \item \imp{肥胖}——增加哮喘发生和加重风险
    \item \imp{抗生素早期暴露}——可能影响肠道菌群发育和免疫成熟
\end{enumerate}

\textbf{儿童哮喘的管理与防控：}
\begin{enumerate}[leftmargin=*]
    \item \imp{避免过敏原和触发因素}——室内控尘螨、禁烟、减少空气污染暴露
    \item \imp{规范药物治疗}——长期控制药物（吸入糖皮质激素为首选）和急性缓解药物
    \item \imp{哮喘行动计划}——个人化书面管理方案，包括日常管理、症状恶化的识别和处理、紧急情况应对
    \item \imp{定期监测}——肺功能监测（峰流速仪），症状控制评估
    \item \imp{学校管理}——学校应了解哮喘学生情况，允许携带急救药物，避免诱发因素
    \item \imp{健康教育和自我管理}——教会患儿和家长正确使用吸入装置，识别急性发作早期信号
\end{enumerate}
\end{keybox}
...
\begin{enumerate}[leftmargin=*, itemsep=8pt]
    \item \textbf{【名词解释】}1型糖尿病；儿童高血压；动脉粥样硬化；支气管哮喘
    ...
    \item \textbf{【简答题】}简述儿童哮喘的危险因素及管理策略。
\end{enumerate}

\subsection*{参考答案要点}

\begin{enumerate}[leftmargin=*, itemsep=5pt]
    \item \textbf{1型糖尿病}：自身免疫性胰岛$\beta$细胞破坏导致胰岛素绝对缺乏，是儿童最常见糖尿病类型（90\%以上）。\textbf{儿童高血压}：血压超过同性别、年龄、身高别的P95。\textbf{动脉粥样硬化}：慢性进行性血管病变，早期病变（脂纹）可在儿童期出现。\textbf{支气管哮喘}：以慢性气道炎症和气道高反应性为特征的异质性疾病，是儿童期最常见的慢性呼吸系统疾病。
    ...
    \item 危险因素：遗传（家族过敏史）、过敏原暴露（尘螨、花粉等）、空气污染/二手烟、呼吸道感染、肥胖、抗生素早期暴露。管理策略：避免触发因素、规范药物治疗（吸入激素为首选）、个人化哮喘行动计划、定期肺功能监测、学校管理和健康教育。
\end{enumerate}
