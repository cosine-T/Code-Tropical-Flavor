...
\textbf{熟悉：}镜头-望远镜模型；故意伤害的素质-易感模型。
}
...
\subsubsection{镜头-望远镜模型}

\begin{defbox}
\textbf{镜头-望远镜模型（Lens-Telescope Model）：}将伤害预防比作通过"镜头"和"望远镜"两个视角审视伤害问题。

\begin{enumerate}[leftmargin=*]
    \item \imp{"镜头"视角（微观）}：聚焦于个体层面的风险因素——个人行为、认知能力、安全意识等。如同用镜头近距离观察个体特征，关注"谁"容易发生伤害。

    \item \imp{"望远镜"视角（宏观）}：拓展至社会层面的决定因素——政策环境、经济发展水平、社会文化规范等。如同用望远镜远距离观察整体格局，关注"什么环境"导致伤害。
\end{enumerate}

\textbf{模型意义：}该模型强调伤害预防不能仅关注个体因素，必须同时从宏观社会决定因素入手，实现微观干预与宏观政策的有机结合。
\end{defbox}
...
\begin{tipbox}
\textbf{守门人培训（Gatekeeper Training）：}培训学校教师、家长、同伴等"守门人"识别自杀警告信号、询问自杀风险、说服求助、转介专业机构的技能。这是学校自杀预防的核心策略之一。"询问-说服-转介"（QPR, Question-Persuade-Refer）是常用的守门人技能模式。
\end{tipbox}
...
\textbf{三、冰山模型}
\begin{enumerate}[leftmargin=*]
    \item 校园暴力的"冰山模型"揭示了校园暴力的隐藏规模：
    \begin{itemize}
        \item 冰山之上（可见部分）：每报告1例死亡，意味着存在更多未报告的严重伤害。
        \item 冰山之下（隐藏部分）：1例死亡 : 50例残疾（严重伤害） : 1000例受伤事件。
        \item 大量轻微伤害和未报告事件构成了冰山的主体。
    \end{itemize}
\end{enumerate}
...
校园暴力的发生可从多层面生态系统理解：
\begin{enumerate}[leftmargin=*]
    \item \imp{个体层面}：年龄、性别、心理特征、暴力经历。
    \item \imp{人际关系层面}：家庭关系、同伴关系、师生关系。
    \item \imp{社区层面}：学校氛围、社区环境、社会治安。
    \item \imp{社会层面}：社会文化规范、贫富差距、法律法规。
\end{enumerate}
...
\textbf{五、危害}
\begin{enumerate}[leftmargin=*]
    \item 对受害者的心理伤害：焦虑、抑郁、孤独、低自尊、创伤后应激障碍（PTSD）。
    \item 对学业和社交的影响：学习成绩下降、逃学、社交退缩。
    \item 极端后果：自伤、自杀。
    \item 网络环境的毒害：网络暴力的蔓延恶化网络环境，形成恶性循环。
\end{enumerate}
...
\begin{defbox}
\textbf{素质-易感模型（Diathesis-Stress Model）：}在故意伤害的解释框架中，该模型认为个体是否发生故意伤害行为（或遭受故意伤害后产生严重心理后果），取决于个体的先天素质/易感性（遗传、人格特征、早期经历等）与后天应激事件（压力生活事件、创伤经历等）的交互作用。高易感个体在面对相同应激水平时，比低易感个体更容易产生故意伤害行为或更严重的伤害后果。
\end{defbox}
