...
\textbf{学校健康教育的5个领域：}
\begin{enumerate}[leftmargin=*]
    \item \imp{健康行为与生活方式}——培养合理膳食、规律作息、个人卫生等健康行为习惯
    \item \imp{疾病预防}——传染病和慢性非传染性疾病的基本预防知识与技能
    \item \imp{生长发育与青春期保健}——青春期生理心理变化、青春期保健知识与技能
    \item \imp{心理健康}——情绪管理、人际交往、压力应对、心理求助等
    \item \imp{安全应急与避险}——意外伤害预防、急救技能、灾害应急避险等
\end{enumerate}
...
\begin{keybox}
\textbf{"四位一体"学生心理健康工作体系：}
\begin{enumerate}[leftmargin=*]
    \item \imp{健康教育}——开设心理健康教育课程，普及心理健康知识，培养学生积极心理品质
    \item \imp{监测预警}——定期开展学生心理健康测评，建立"一生一策"心理健康档案，完善预警干预机制
    \item \imp{咨询服务}——设立心理辅导室，配备专兼职心理健康教师，提供个体咨询和团体辅导
    \item \imp{干预处置}——建立学校、家庭、医疗机构联动转介机制，对心理危机学生及时干预和转介治疗
\end{enumerate}
...
\begin{keybox}
\textbf{2022年中国学龄儿童膳食指南5项核心推荐：}
\begin{enumerate}[leftmargin=*]
    \item \imp{主动参与食物选择和制作}，提高营养素养
    \item \imp{吃好早餐，合理选择零食}，培养健康饮食行为
    \item \imp{天天喝奶，足量饮水}，不喝含糖饮料，禁止饮酒
    \item \imp{多户外活动，少视屏时间}，每天60分钟以上中高强度身体活动
    \item \imp{定期监测体格发育}，保持体重适宜增长
\end{enumerate}
...
\textbf{核心要求——每天锻炼2小时：}
\begin{enumerate}[leftmargin=*]
    \item \imp{体育课}：开齐开足体育与健康课程，保障体育教学时间和质量
    \item \imp{大课间活动}：每天统一安排30分钟大课间体育活动
    \item \imp{课外体育活动}：组织课后体育锻炼和体育社团活动
    \item \imp{校外体育活动}：鼓励学生放学后和节假日参加体育活动
\end{enumerate}
...
\begin{defbox}
\textbf{中国健康学校建设的三大任务目标：}
\begin{enumerate}[leftmargin=*]
    \item \imp{加强学生健康监测与干预}：建立完善的学生健康监测体系，开展学生常见病和健康危险行为监测，实施针对性干预措施。
    \item \imp{提升学校卫生服务能力}：配齐配强校医或保健教师，完善学校卫生室（保健室）建设，增强学校传染病防控和应急处置能力。
    \item \imp{建设健康环境}：改善学校教学和生活环境（教室采光照明、课桌椅、饮用水、厕所等），创建无烟学校，营造积极健康的校园文化氛围。
\end{enumerate}
\end{defbox}
...
\begin{enumerate}[leftmargin=*]
    \item \imp{预防性卫生监督（preventive supervision）}：在学校建设项目的规划、设计、施工和竣工验收阶段进行的卫生审查和监督活动。目的是从源头上保障学校建筑和设施的卫生安全，是学校卫生的第一道防线。

    \textbf{适用情形：}新建、改建、扩建校舍的选址与设计审查；教学和生活设施设备的配置审查。

    \item \imp{经常性/常规性卫生监督（routine supervision）}：卫生监督机构按照国家年度监督计划或根据工作需要，对学校的日常卫生工作进行的定期或不定期监督检查。

    \textbf{主要内容：}教学和生活环境卫生、传染病防控、饮用水卫生、学校医疗机构/保健室、公共场所卫生等。
\end{enumerate}
