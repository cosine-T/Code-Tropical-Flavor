...
\chapterintro{
掌握职业卫生与职业医学的概念和定义；理解劳动与健康的关系；掌握职业有害因素（生产过程、劳动过程、生产环境）及其来源；掌握职业病的特点、诊断原则和三级预防原则；熟悉工作有关疾病和工伤的概念；了解职业卫生服务的基本内容。
}
...
\begin{enumerate}[leftmargin=*]
    ...
    \end{itemize}
    \item \imp{生物因素}：炭疽杆菌、布氏杆菌、森林脑炎病毒、过敏性肺炎、艾滋病病毒（职业暴露）
\end{enumerate}
...
\chapterintro{
掌握体力劳动时的能量代谢、氧消耗的动态及劳动强度分级；掌握动力定型和静力/动力作业的特点；掌握劳动负荷评价；掌握紧张反应的表现；掌握影响作业能力的主要因素；熟悉三种劳动类型（能量性、感觉运动式、信息性）；熟悉职业紧张的概念和模型（JD-C、ERI）；了解工效学原理及其应用。
}
...
\chapterintro{
本章为课程核心章节（12学时）。掌握毒物、生产性毒物、职业中毒的基本概念；掌握毒物进入机体的途径及体内过程（吸收、分布、代谢、排泄）；掌握影响毒物毒作用的因素；掌握职业中毒的临床类型和诊断原则；掌握铅、汞、锰的毒作用机制及临床表现；掌握刺激性气体（中毒性肺水肿）和窒息性气体（CO、HCN、H₂S）的毒作用特点及救治原则；熟悉苯、有机溶剂、苯的氨基和硝基化合物、高分子化合物、农药的中毒机制与预防。
}
...
硝基苯 $\gg$ 苯胺 $>$ 硝基甲苯 $>$ 二硝基甲苯 $>$ 三硝基甲苯（TNT）

MetHb形成能力最强的是硝基苯，其次为苯胺。TNT虽有三硝基结构但其MetHb形成能力相对较弱，其主要毒性表现为中毒性白内障和中毒性肝炎。
\end{exambox}

\textbf{高铁血红蛋白血症的治疗：}亚甲蓝（美蓝）——将Fe$^{3+}$-Hb还原为Fe$^{2+}$-Hb。需小剂量使用（1--2mg/kg），大剂量反而氧化Hb。

\subsection{苯胺（Aniline）}
经呼吸道和皮肤吸收。主要表现为高铁血红蛋白血症（发绀）、溶血性贫血、中毒性肝炎和膀胱刺激症状。

\subsection{三硝基甲苯（TNT）}
经呼吸道、皮肤和消化道吸收。主要损害：\keyword{中毒性白内障}（最特征性改变，晶状体混浊*）、中毒性肝炎（中毒性肝病）和再生障碍性贫血。
\end{keybox}
...
\chapterintro{
本章为课程核心章节（15学时，占比最大）。掌握生产性粉尘的定义、来源及分类；掌握粉尘的理化性质及其卫生学意义*；掌握矽肺的定义、病理改变（矽结节）和X线诊断分期；掌握石棉肺的病理特征和临床表现；掌握煤工尘肺、硅酸盐尘肺、有机粉尘引起的肺部疾病；掌握尘肺病的预防和控制（防尘八字方针）。
}
...
\begin{itemize}[leftmargin=*]
    ...
    \item \keyword{可吸入性粉尘（IP）}：粒径$\leq$15$\mu$m，能进入呼吸道
    \item \keyword{呼吸性粉尘（RP）}：粒径$\leq$5$\mu$m，能到达肺泡
...
\begin{itemize}[leftmargin=*]
    ...
    \item 并发症：肺结核（\keyword{矽肺结核}，最常见最严重并发症）、肺部感染、自发性气胸、肺心病、呼吸衰竭
\end{itemize}
...
\textbf{X线诊断分期：}
\begin{enumerate}[leftmargin=*]
    \item \imp{一期尘肺（I）}：有总体密集度1级的小阴影，分布范围至少达到2个肺区
    \item \imp{二期尘肺（II）}：有总体密集度2级的小阴影，分布范围超过4个肺区；或有总体密集度3级的小阴影，分布范围达到4个肺区
    \item \imp{三期尘肺（III）}：有大阴影出现，其长径$\geq$20mm，短径$\geq$10mm
\end{enumerate}
\end{keybox}
...
\hline
\imp{肺功能损害} & 限制性通气功能障碍 & \textbf{限制性通气功能障碍}为主，肺顺应性↓ & 阻塞性或混合性通气功能障碍 \\
\hline
...
\begin{enumerate}[leftmargin=*, itemsep=5pt]
    ...
    \item 一期：总体密集度1级小阴影，分布至少2个肺区。二期：密集度2级小阴影，分布超4个肺区；或3级达4个肺区。三期：大阴影长径$\geq$20mm，短径$\geq$10mm。
...
\chapterintro{
本章为课程重要章节（12学时）。掌握高温作业的类型、中暑的临床分型及救治原则；掌握生产性噪声的类型、评价指标和听力损伤的特征；掌握局部振动病（手臂振动病）的概念和临床表现；了解电离辐射和非电离辐射的健康危害；熟悉异常气压（高气压、低气压）对健康的影响及减压病。
}
...
\begin{itemize}[leftmargin=*]
    \item 最严重类型，体温调节功能衰竭，死亡率高
    \item 特征：\keyword{高热（体温>40$^\circ$C）+ 无汗 + 意识障碍}
    \item 机制：体温调节中枢功能衰竭→产热>散热
\end{itemize}

\textbf{2. 热痉挛（Heat Cramps）}：
\begin{itemize}[leftmargin=*]
    \item 大量出汗后仅补水未补盐→低钠血症→肌肉痉挛（腓肠肌最多见）
    \item 体温多正常或轻度升高
\end{itemize}

\textbf{3. 热衰竭（Heat Exhaustion）}：
\begin{itemize}[leftmargin=*]
    \item 大量失水失盐→有效循环血量不足→虚脱
    \item 特征：面色苍白、皮肤湿冷、脉搏细弱、血压降低、昏厥
\end{itemize}

\textbf{中暑的诊断（GBZ 41-2019）：}
\begin{itemize}[leftmargin=*]
    \item 中暑先兆：头晕、头痛、口渴、多汗、心悸、注意力不集中
    \item 轻症中暑：体温>38.5$^\circ$C，面色潮红、口渴、脉搏增快
    \item 重症中暑：热射病、热痉挛、热衰竭
\end{itemize}

\textbf{救治原则：}
\begin{enumerate}[leftmargin=*]
    \item 立即脱离高温环境
    \item \imp{快速降温}——冷水/冰水擦浴、冰袋（颈、腋、腹股沟）
...
\textbf{预防措施：}
\begin{enumerate}[leftmargin=*]
    \item 技术措施：隔绝热源、隔热、通风降温（自然通风+机械通风）、空调
    \item 保健措施：合理供应清凉饮料（含盐0.15--0.2\%）；合理膳食（补充蛋白质、维生素）
    \item 组织措施：合理安排作息制度（轮换作业、延长休息）、高温作业标准（WBGT）
\end{enumerate}
\end{keybox}

\subsection{我国高温作业卫生标准}

以\keyword{湿球黑球温度指数（WBGT）}为评价指标。WBGT综合反映气温、气湿、气流和热辐射四种物理因素对机体的作用。根据体力劳动强度和接触时间制定不同限值。
...
\textbf{噪声聋（Noise-Induced Deafness）}：长期接触生产性噪声引起的以高频听力下降为主、继而语言频率听力下降的\keyword{感音性耳聋}。属于法定职业病。
...
\begin{enumerate}[leftmargin=*, itemsep=8pt]
    ...
    \item \textbf{【简答题】}简述中暑的三种临床分型及其特征（热射病、热痉挛、热衰竭）。
...
\begin{enumerate}[leftmargin=*, itemsep=5pt]
    ...
    \item 热射病：体温>40$^\circ$C、无汗、意识障碍（最严重，死亡率高）。热痉挛：大量出汗补水未补盐→低钠→肌肉痉挛（腓肠肌多见）。热衰竭：失水失盐→有效循环血量不足→虚脱（面色苍白、皮肤湿冷、血压↓）。
...
\chapterintro{
掌握职业性致癌因素的概念和分类（确认致癌物、可疑致癌物、潜在致癌物）；掌握职业性肿瘤的特点*（潜伏期、阈值、剂量-反应关系、好发部位、影响因素）；掌握我国法定职业性肿瘤（11种）及其接触因素；了解职业性致癌因素的识别与判定方法。
}
...
% =====================================================================
%  CHAPTER 9: 职业有害因素的识别与评价
% =====================================================================
\chapter{职业有害因素的识别与评价}
\setcounter{chapter}{9}
\chapterintro{
掌握职业卫生调查的步骤和方法； 掌握作业环境监测中化学物质的采样和测定方法；掌握生物监测的概念、特点和指标；掌握职业流行病学调查在职业卫生中的应用；掌握职业有害因素的危险度评价。
}
...
% =====================================================================
%  CHAPTER 10: 职业有害因素的监督与控制
% =====================================================================
\chapter{职业有害因素的监督与控制}
\setcounter{chapter}{10}
\chapterintro{
掌握职业卫生标准的分类和应用；掌握工业通风的类型和原理；掌握个人防护用品的分类和适用条件；了解职业卫生监督的类型和内容。
}
...
% =====================================================================
%  CHAPTER 11: 主要行业的职业卫生
% =====================================================================
\chapter{主要行业的职业卫生}
\setcounter{chapter}{11}
\chapterintro{
了解采矿、冶金、化工、建筑、农业等行业的主要职业有害因素及防护要点。
}
