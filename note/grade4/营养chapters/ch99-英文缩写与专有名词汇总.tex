...
\chapter{英文缩写与专有名词汇总}
\chapterintro{
本附录收录《营养与食品卫生学》课程中出现的全部英文缩写及专有名词，按类别分为十一大类，以表格形式呈现，方便对照复习和查阅。
}
...
ESPEN & European Society for Clinical Nutrition and Metabolism \hfill 欧洲临床营养与代谢学会 \\
ASPEN & American Society for Parenteral and Enteral Nutrition \hfill 美国肠外肠内营养学会 \\
...
NEAA & Non-Essential Amino Acid \hfill 非必需氨基酸 \\
AMC & Arm Muscle Circumference \hfill 上臂肌围 \\
AMA & Arm Muscle Area \hfill 上臂肌区 \\
TSF & Triceps Skinfold \hfill 三头肌部皮褶厚度 \\
SAAR & Serum Amino Acid Ratio \hfill 血清氨基酸比值 \\
\bottomrule
\end{tabularx}
\end{table}
...
CM & Chylomicron \hfill 乳糜微粒 \\
\bottomrule
\end{tabularx}
\end{table}

\subsection*{（三）碳水化合物与能量}
...
RS & Resistant Starch \hfill 抗性淀粉 \\
DLW & Doubly Labeled Water \hfill 双标水法 \\
ICF & Intracellular Fluid \hfill 细胞内液 \\
ECF & Extracellular Fluid \hfill 细胞外液 \\
\bottomrule
\end{tabularx}
\end{table}
...
EER & Estimated Energy Requirement \hfill 能量需要量 \\
INQ & Index of Nutrition Quality \hfill 营养质量指数 \\
CFCT & Chinese Food Composition Table \hfill 中国食物成分表 \\
\bottomrule
\end{tabularx}
\end{table}
...
ONS & Oral Nutrition Supplement \hfill 口服营养补充 \\
TEN & Total Enteral Nutrition \hfill 全肠内营养 \\
PEG & Percutaneous Endoscopic Gastrostomy \hfill 经皮内镜下胃造瘘 \\
NCJ & Needle Catheter Jejunostomy \hfill 穿刺式空肠造瘘 \\
PORT & Implantable Venous Access Port \hfill 植入式静脉输液港 \\
TNA & Total Nutrient Admixture \hfill 全营养混合液（全合一） \\
\bottomrule
\end{tabularx}
\end{table}
...
GAP & Good Agricultural Practice \hfill 良好农业生产规范 \\
OCPs & Organochlorine Pesticides \hfill 有机氯农药 \\
OPPs & Organophosphorus Pesticides \hfill 有机磷农药 \\
...
HCA & Heterocyclic Amine \hfill 杂环胺 \\
NDMA & N-Nitrosodimethylamine \hfill 二甲基亚硝胺 \\
NDEA & N-Nitrosodiethylamine \hfill 二乙基亚硝胺 \\
SCN$^-$ & Thiocyanate \hfill 硫氰酸盐（亚硝胺合成催化剂） \\
3-MCPD & 3-Monochloropropane-1,2-diol \hfill 3-氯-1,2-丙二醇 \\
HVP & Hydrolyzed Vegetable Protein \hfill 水解植物蛋白 \\
PCB & Polychlorinated Biphenyl \hfill 多氯联苯 \\
POPs & Persistent Organic Pollutants \hfill 持久性有机污染物 \\
CYP450 & Cytochrome P450 \hfill 细胞色素P450酶系 \\
PET & Polyethylene Terephthalate \hfill 聚对苯二甲酸乙二醇酯（塑料） \\
PC & Polycarbonate \hfill 聚碳酸酯（塑料） \\
PE & Polyethylene \hfill 聚乙烯 \\
PP & Polypropylene \hfill 聚丙烯 \\
PS & Polystyrene \hfill 聚苯乙烯 \\
SML & Specific Migration Limit \hfill 特定迁移限量 \\
OML & Overall Migration Limit \hfill 总迁移限量 \\
\bottomrule
\end{tabularx}
\end{table}
...
AFQ1 & Aflatoxin Q1 \hfill 黄曲霉毒素Q1（AFB1代谢产物） \\
AFH1 & Aflatoxin H1 \hfill 黄曲霉毒素H1（AFB1代谢产物） \\
FB1 & Fumonisin B1 \hfill 伏马菌素B1 \\
FB2 & Fumonisin B2 \hfill 伏马菌素B2 \\
\bottomrule
\end{tabularx}
\end{table}
...
SOP & Standard Operating Procedure \hfill 标准操作规程 \\
...
TSE & Transmissible Spongiform Encephalopathy \hfill 传染性海绵状脑病 \\
CJD & Creutzfeldt-Jakob Disease \hfill 克雅氏病 \\
...
GMF & Genetically Modified Food \hfill 转基因食品 \\
GB & Guo Biao (National Standard) \hfill 国家标准（食品安全国家标准） \\
MSG & Monosodium Glutamate \hfill 谷氨酸钠（味精） \\
DLTP & Dilauryl Thiodipropionate \hfill 硫代二丙酸二月桂酯（抗氧化剂） \\
SO$_2$ & Sulfur Dioxide \hfill 二氧化硫（漂白剂/防褐变剂） \\
CoQ10 & Coenzyme Q10 (Ubiquinone) \hfill 辅酶Q10（泛醌） \\
GABA & $\gamma$-Aminobutyric Acid \hfill $\gamma$-氨基丁酸 \\
ER & Estrogen Receptor \hfill 雌激素受体 \\
HO-1 & Heme Oxygenase-1 \hfill 血红素加氧酶-1 \\
Nrf2 & Nuclear factor erythroid 2-related factor 2 \hfill 核因子E2相关因子2 \\
NF-$\kappa$B & Nuclear Factor-$\kappa$B \hfill 核因子-$\kappa$B \\
ITCs & Isothiocyanates \hfill 异硫氰酸盐 \\
GST & Glutathione S-Transferase \hfill 谷胱甘肽S-转移酶（II相解毒酶） \\
UGT & UDP-Glucuronosyltransferase \hfill UDP-葡萄糖醛酸转移酶（II相解毒酶） \\
NQO1 & NAD(P)H:Quinone Oxidoreductase 1 \hfill 醌氧化还原酶1（II相解毒酶） \\
EGCG & Epigallocatechin Gallate \hfill 表没食子儿茶素没食子酸酯 \\
CAT & Catalase \hfill 过氧化氢酶 \\
GPx & Glutathione Peroxidase \hfill 谷胱甘肽过氧化物酶 \\
DADS & Diallyl Disulfide \hfill 二烯丙基二硫化物 \\
DATS & Diallyl Trisulfide \hfill 二烯丙基三硫化物 \\
IP6 & Inositol Hexaphosphate (Phytic Acid) \hfill 肌醇六磷酸（植酸） \\
BM & Breast Milk \hfill 母乳 \\
NTDs & Neural Tube Defects \hfill 神经管畸形 \\
PMOP & Postmenopausal Osteoporosis \hfill 绝经后骨质疏松 \\
\bottomrule
\end{tabularx}
\end{table}
...
\textbf{缩写} & \textbf{全称与中文释义} \\
\midrule
AV & Acid Value \hfill 酸价 \\
POV & Peroxide Value \hfill 过氧化值 \\
CGV & Carbonyl Value \hfill 羰基价 \\
MDA & Malondialdehyde \hfill 丙二醛 \\
SCE & Sister Chromatid Exchange \hfill 姐妹染色单体交换 \\
\bottomrule
\end{tabularx}
\end{table}

% ===== 十、氨基酸三字母/单字母对照 =====
\section{十、常见氨基酸三字母与单字母缩写对照}
