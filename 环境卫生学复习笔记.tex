...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{\color{mainblue}蓝色框}为概念释义，帮助理解专业术语。
...
\begin{tcolorbox}[colback=lightblue, colframe=mainblue, boxrule=0.5pt, arc=4pt, title=\textbf{环境卫生学的研究内容}, breakable]
...
\vspace*{3cm}
\begin{center}
    {\Large\color{mainblue}\textbf{--- 复习笔记完 ---}}\\[20pt]
